...
void CarGo(void)
{
	front_left_speed_duty=attention;
	front_right_speed_duty=attention; // 左电机
	behind_left_speed_duty=attention; //右电机
	behind_right_speed_duty=attention;
}
...
//	front_right_speed_duty=SPEED_DUTY+10; // 左电机
//	behind_left_speed_duty=SPEED_DUTY+10; //右电机
//	behind_right_speed_duty=SPEED_DUTY+10;
//}

//void CarGo3(void)
//{
//	front_left_speed_duty=SPEED_DUTY+15;
//	front_right_speed_duty=SPEED_DUTY+15; // 左电机
//	behind_left_speed_duty=SPEED_DUTY+15; //右电机
//	behind_right_speed_duty=SPEED_DUTY+15;
//}

//void CarGo4(void)
//{
//	front_left_speed_duty=SPEED_DUTY+20;
//	front_right_speed_duty=SPEED_DUTY+20; // 左电机
//	behind_left_speed_duty=SPEED_DUTY+20; //右电机
//	behind_right_speed_duty=SPEED_DUTY+20;
//}
